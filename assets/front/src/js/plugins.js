			...
			var l = a.from,
				...
				o = setInterval(function () {
					(l += s),
						i++,
						e(t)
							.find(a.classes.skillBarPercent)
							.text(l.toFixed(a.decimals) + "%"),
						"function" == typeof a.onUpdate && a.onUpdate.call(t, l);
					i >= r &&
						(clearInterval(o),
						(l = n),
						"function" == typeof a.onComplete && a.onComplete.call(t, l));
				}, a.interval);
...
(function (i) {
	...
	(function () {
		for (
			var k = 0, l = ["ms", "moz", "webkit", "o"], m = 0;
			m < l.length && !window.requestAnimationFrame;
			++m
		)
			(window.requestAnimationFrame = window[l[m] + "RequestAnimationFrame"]),
				(window.cancelAnimationFrame =
					window[l[m] + "CancelAnimationFrame"] ||
					window[l[m] + "CancelRequestAnimationFrame"]);
		...
		(i.fn.isOnScreen = function () {
			var k = i(window),
				l = { top: k.scrollTop(), left: k.scrollLeft() };
			(l.right = l.left + k.width()), (l.bottom = l.top + k.height());
			var m = this.offset();
			return (
				(m.right = m.left + this.outerWidth()),
				(m.bottom = m.top + this.outerHeight()),
				!(
					l.right < m.left ||
					l.left > m.right ||
					l.bottom < m.top ||
			...
			return this.each(function () {
				function l(Y) {
					return (
						...
						(N = r.width()),
						j() && (U = 2),
						("left" === X.parallaxDirection ||
							"right" === X.parallaxDirection) &&
							(F += U * Math.ceil(N * parseFloat(X.parallaxSpeed))),
						("up" === X.parallaxDirection || "down" === X.parallaxDirection) &&
							(B += U * Math.ceil(M * parseFloat(X.parallaxSpeed))),
						[F, B]
					);
				}
				function m(Y, Z) {
					switch (
						((I = parseInt(Y.css("padding-left").replace("px", ""))),
						(J = parseInt(Y.css("padding-right").replace("px", ""))),
						(G = parseInt(Y.css("padding-top").replace("px", ""))),
						(H = parseInt(Y.css("padding-bottom").replace("px", ""))),
						(K = (Z[1] - Y.outerHeight()) / 2),
						(L = (Z[0] - Y.outerWidth()) / 2),
						X.parallaxDirection)
					) {
						case "up":
							(Q = -I), (R = -(K + G)), (S = 0);
				...
				1 < X.parallaxSpeed
					? (X.parallaxSpeed = 1)
					: 0 > X.parallaxSpeed && (X.parallaxSpeed = 0),
					1 > q.find(".parallax-inner").length &&
						q.prepend('<div class="parallax-inner"></div>'),
					(u = q.find(".parallax-inner")),
					(v = l(q)),
					(A = m(q, v)),
					q.css({
						position: "relative",
					...
					u.css({
						...
						height: v[1],
						transform:
							"translate3d(" + A[0] + "px, " + A[1] + "px, " + A[2] + "px)",
					...
					("left" === X.parallaxDirection || "right" === X.parallaxDirection) &&
						((C = 0), (D = A[0])),
					("up" === X.parallaxDirection || "down" === X.parallaxDirection) &&
						((C = 0), (D = A[1])),
					(P = r.scrollTop()),
					r.on("scroll", function () {
						0 < P && (T = o(P)),
							(P = r.scrollTop()),
							q.isOnScreen()
								? ((C = T * (parseFloat(X.parallaxSpeed) / 4)),
								  "up" === X.parallaxDirection &&
										n(q) > n(u) + 50 &&
										((D += -C),
										(E =
											"translate3d(" +
								  ...
								  "right" === X.parallaxDirection &&
										...
										(E =
											...
											A[2] +
											"px)")),
								  u.css({ width: v[0], height: v[1], transform: E }))
								: (("up" === X.parallaxDirection ||
										"down" === X.parallaxDirection) &&
										(D = A[1]),
								  ("left" === X.parallaxDirection ||
	...
	a.fn.countdown = function (b, c) {
		function e() {
			(eventDate = Date.parse(d.date) / 1e3),
				...
				eventDate <= currentDate && (c.call(this), clearInterval(interval)),
		...
		s = {
			init: function (t) {
				return (
					...
					(s.settings = {
						state: !1,
						events: { opened: "side-menu.opened", closed: "side-menu.closed" },
						dropdownEvents: {
			...
			refresh: function () {
				this.iScroll = new IScroll(
					...
					e(this).data("side-menu").options.iscroll
				);
			},
			addOverlay: function () {
				var t = e(this),
			...
			destroy: function () {
				return this.each(function () {
					var t = this,
						n = e(this);
					e("." + s.settings.class.toggle).off("click.side-menu"),
						e(window).off("resize.side-menu"),
	...
	(e.fn.sidemenuCallback = function (t) {
		...
		(e.fn.sidemenu = function (t) {
			return s[t]
				...
				: "object" != typeof t && t
				? void e.error("Method " + t + " does not exist on jQuery.side-menu")
		...
		(t.typeIt.prototype = {
			_init: function () {
				this.el.find(".ti-container, .ti-cursor, .ti-placeholder").remove(),
					...
					this.el.html(
						'<i class="ti-placeholder" style="display:inline-block;line-height:0;visibility:hidden;overflow:hidden;">.</i><span ' +
							this.style +
	...
	(e.fn.fullpage = function (l) {
		function s(n, t) {
			...
			l.autoScrolling && !l.scrollBar
				? (xt.css({ overflow: "hidden", height: "100%" }),
				  q(Gt.recordHistory, "internal"),
				  Rt.css({ "-ms-touch-action": "none", "touch-action": "none" }),
				  o.length && ct(o.position().top))
				: (xt.css({ overflow: "visible", height: "initial" }),
				  q(!1, "internal"),
				  Rt.css({ "-ms-touch-action": "", "touch-action": "" }),
				  pt(Rt),
		...
		function ve(n) {
			...
			n
				? t ||
				  ...
				  l.responsiveSlides &&
						At.responsiveSlides &&
						At.responsiveSlides.toSections(),
				  Rt.trigger("afterResponsive", [n]))
				: t &&
				  (s(Gt.autoScrolling, "internal"),
		...
		function Se() {
			ne.on("scroll", Be).on("hashchange", pn).blur(bn).resize(En),
				te
					.keydown(vn)
					.keyup(mn)
					.on("click touchstart", M + " a", xn)
					.on("click touchstart", N, Cn)
					.on("click", E, gn),
		...
		function be() {
			Rt.css({ height: "100%", position: "relative" }),
				Rt.addClass(r),
				e("html").addClass(u),
				(Ht = ne.height()),
				Rt.removeClass(f),
				...
				l.scrollOverflow
					? ("complete" === t.readyState && Me(), ne.on("load", Me))
					: He();
		}
		function xe(n, t, o) {
			var i = 100 * o,
			...
			t.wrapAll('<div class="' + V + '" />'),
				...
				o > 1 && (l.controlArrows && ke(n), l.slidesNavigation && Xn(n, o)),
				t.each(function (n) {
		...
		function Ce(e) {
			return l.offsetSections && At.offsetSections
				? At.offsetSections.getWindowHeight(e)
				: Ht;
		}
		function Ae(n, t) {
		...
		function De() {
			...
			if ((!l.autoScrolling || l.scrollBar || vt("dragAndMove")) && !St()) {
				var i = vt("dragAndMove")
						? o.abs(At.dragAndMove.getCurrentScroll())
						: ne.scrollTop(),
					r = (Fe(i), 0),
					a = i + ne.height() / 2,
					s = vt("dragAndMove")
						? At.dragAndMove.getDocumentHeight()
						: Ct.height() - ne.height(),
					c = s === i,
			...
			if (Ft.m[e]) {
				...
				if (
					(At.scrollHorizontally &&
						(o = At.scrollHorizontally.getScrollSection(e, o)),
					n.length > 0)
				) {
		...
		function je(n) {
			...
			if (!Ze(n.target) && Ye(t)) {
				...
				($t = a.y),
					(eo = a.x),
					i.find(F).length && o.abs(Jt - eo) > o.abs(Kt - $t)
						? !Mt &&
						  o.abs(Jt - eo) > (ne.outerWidth() / 100) * l.touchSensitivity &&
						  (Jt > eo ? Ft.m.right && ue(i) : Ft.m.left && he(i))
						: l.autoScrolling &&
						  Dt &&
						  o.abs(Kt - $t) > (ne.height() / 100) * l.touchSensitivity &&
						  (Kt > $t ? Ve("down", r) : $t > Kt && Ve("up", r));
			}
		}
		function Ze(n, t) {
			t = t || 0;
			...
			return (
				...
				(t != l.normalScrollElementTouchThreshold && Ze(o, ++t))
			);
		}
		function Ye(e) {
		...
		function Qe(e) {
			var n = e.position(),
				t = n.top,
				o =
					vt("dragAndMove") && At.dragAndMove.isGrabbing
						? At.dragAndMove.isScrollingDown()
						: n.top > oo,
			...
			return (
				e.outerHeight() > Ht
					? ((o || r) && "bottom" !== r) || (t = i)
					: (o || (zt && e.is(":last-child"))) && (t = i),
				l.offsetSections &&
					At.offsetSections &&
					(t = At.offsetSections.getSectionPosition(o, t, e)),
				(oo = t),
				t
			);
		}
			...
			if ("undefined" != typeof n && n.length) {
				...
				(s.activeSection.is(n) && !zt) ||
					...
					(e.isFunction(l.onLeave) &&
						...
						(vt("scrollOverflowReset") &&
							At.scrollOverflowReset.setPrevious(s.activeSection),
		...
		function $e(n) {
			return (
				n.isMovementUp
					? n.activeSection.before(n.activeSection.nextAll(y))
					: n.activeSection.after(n.activeSection.prevAll(y).get().reverse()),
				ct(e(b).position().top),
				Xe(),
		...
		function Tn(e) {
			Dt &&
				(e.pageY < io && Ft.m.up ? se() : e.pageY > io && Ft.m.down && ce()),
				(io = e.pageY);
		}
		function In(n, t, o) {
			var i = n.closest(y),
			...
			return (
				(r.xMovement = Vn(r.prevSlideIndex, r.slideIndex)),
				...
				l.onSlideLeave.call(
					...
					: (t.addClass(p).siblings().removeClass(p),
					  r.localIsResizing || (ln(r.prevSlide), on(t)),
					  kn(r),
					  i.hasClass(p) &&
							!r.localIsResizing &&
							Qn(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex),
					  At.continuousHorizontal && At.continuousHorizontal.apply(r),
					  St() ? Ln(r) : Mn(n, r, !0),
					  void (
							l.interlockedSlides &&
							At.interlockedSlides &&
							At.interlockedSlides.apply(r)
					  ))
			);
		}
		function kn(e) {
			!l.loopHorizontal &&
				l.controlArrows &&
				(e.section.find(_).toggle(0 !== e.slideIndex),
		...
		function Wn(e) {
			if (!e.hasClass("fp-noscroll")) {
				...
				n > a
					? r.length
						? t.update(e, a)
						: (l.verticalCentered ? e.find(T).wrapInner(o) : e.wrapInner(o),
		...
		function jn(e) {
			e.hasClass(j) ||
				e
					.addClass(j)
					.wrapInner(
						'<div class="' + A + '" style="height:' + Zn(e) + 'px;" />'
					);
		}
		function Zn(e) {
			var n = Ce(e);
		...
		function et() {
			t.addEventListener
				? (t.removeEventListener("mousewheel", Ue, !1),
				  t.removeEventListener("wheel", Ue, !1),
				  t.removeEventListener("MozMousePixelScroll", Ue, !1))
				: t.detachEvent("onmousewheel", Ue);
		}
		function nt() {
			var e,
				o = "";
			...
			var r =
				"onwheel" in t.createElement("div")
					...
					: "DOMMouseScroll";
			"DOMMouseScroll" == r
				? t[e](o + "MozMousePixelScroll", Ue, !1)
				: t[e](o + r, Ue, !1);
		}
		function tt() {
		...
		function it() {
			(Ot || Et) &&
				(l.autoScrolling && Ct.off(Ut.touchmove).on(Ut.touchmove, We),
				e(a)
					.off(Ut.touchstart)
					.on(Ut.touchstart, Ne)
					.off(Ut.touchmove)
		...
		function vt(e) {
			return null !== l[e] && "object" == typeof l[e]
				? l[e].enabled && At[e]
				: l[e] && At[e];
		}
		function gt(e, n, t) {
		...
		var Tt,
			...
			Pt = [],
			Ft = {};
		(Ft.m = { up: !0, down: !0, left: !0, right: !0 }),
...
+(function (t) {
	...
	function r(e) {
		return this.each(function () {
			...
			(i || "destroy" != e) &&
				(i || r.data("bs.validator", (i = new a(this, o))),
				"string" == typeof e && i[e]());
		});
	}
	var a = function (r, o) {
		(this.options = o),
			(this.$element = t(r)),
			(this.$inputs = this.$element.find(a.INPUT_SELECTOR)),
			(this.$btn = t('button[type="submit"], input[type="submit"]')
				.filter('[form="' + this.$element.attr("id") + '"]')
				.add(
					this.$element.find('input[type="submit"], button[type="submit"]')
				)),
			(o.errors = t.extend({}, a.DEFAULTS.errors, o.errors));
		for (var i in o.custom)
			if (!o.errors[i])
				throw new Error(
					"Missing default error message for custom validator: " + i
				);
		t.extend(a.VALIDATORS, o.custom),
	...
	(a.INPUT_SELECTOR = ':input:not([type="submit"], button):enabled:visible'),
		(a.FOCUS_OFFSET = 20),
		(a.DEFAULTS = {
			delay: 500,
			html: !1,
		...
		(a.prototype.validateInput = function (r, a) {
			...
			r.data("bs.validator.previous", o),
				r.is('[type="radio"]') &&
					(r = this.$element.find('input[name="' + r.attr("name") + '"]'));
			var n = t.Event("validate.bs.validator", { relatedTarget: r[0] });
			if ((this.$element.trigger(n), !n.isDefaultPrevented())) {
				...
				return this.runValidators(r).done(function (e) {
					r.data("bs.validator.errors", e),
						e.length
							? a
								? d.defer(r, d.showErrors)
								: d.showErrors(r)
							: d.clearErrors(r),
						(s && e.toString() === s.toString()) ||
							((n = e.length
		...
		(a.prototype.runValidators = function (r) {
			function o(t) {
				return (
					r.data(t + "-error") ||
					r.data("error") ||
					("native" == t && r[0].validationMessage) ||
					n.errors[t]
				);
			}
			var i = [],
			...
			return (
				...
				r.data("bs.validator.deferred", s),
				t.each(
					a.VALIDATORS,
		...
		(a.prototype.showErrors = function (e) {
			...
			a.length &&
				...
				void 0 === i.data("bs.validator.originalContent") &&
					i.data("bs.validator.originalContent", i.html()),
				i.empty().append(a),
				o.addClass("has-error has-danger"),
				o.hasClass("has-feedback") &&
					s.removeClass(this.options.feedback.success) &&
					s.addClass(this.options.feedback.error) &&
					o.removeClass("has-success"));
		}),
		(a.prototype.clearErrors = function (t) {
			...
			a.html(a.data("bs.validator.originalContent")),
				r.removeClass("has-error has-danger"),
				r.hasClass("has-feedback") &&
					o.removeClass(this.options.feedback.error) &&
					e(t) &&
					o.addClass(this.options.feedback.success) &&
...
!(function (n) {
	...
	var a = {
		...
		event: function () {
			...
			if (
				(o && a.wrap("<div class='wrap-sticky'></div>"),
				a.hasClass("brand-center"))
			) {
				var s = new Array(),
					e = n("nav.brand-center"),
					t = e.find("ul.navbar-nav");
				e.prepend("<span class='storage-name' style='display:none;'></span>"),
					e.find("ul.navbar-nav > li").each(function () {
				...
				r(i),
					t.html(d),
					e.find("ul.nav").first().addClass("navbar-left"),
					r(l),
					t.after('<ul class="nav navbar-nav"></ul>').next().html(d),
					e.find("ul.nav").last().addClass("navbar-right"),
					e
					...
					e.find("ul.navbar-nav > li").each(function () {
						...
						a.closest("li").addClass("dropdown"),
							o.closest("li").addClass("megamenu-fw");
					});
				var c = n(".storage-name").html();
				"" == !c &&
					n("ul.navbar-nav > li:contains('" + c + "')").addClass("active");
			}
			a.hasClass("navbar-sidebar")
				? (n("body").addClass("wrap-nav-sidebar"),
				  a.wrapInner("<div class='scroller'></div>"))
				: n(".bootsnav").addClass("on"),
				a.find("ul.nav").hasClass("navbar-center") && a.addClass("menu-center"),
				a.hasClass("navbar-full")
					? (n("nav.navbar.bootsnav")
							.find("ul.nav")
							.wrap("<div class='wrap-full-menu'></div>"),
					  n(".wrap-full-menu").wrap("<div class='nav-full'></div>"),
					  n("ul.nav.navbar-nav").prepend(
							"<li class='close-full-menu'><a href='#'><i class='fa ion-android-close'></i></a></li>"
					  ))
					: a.hasClass("navbar-mobile")
					? a.removeClass("no-full")
					: a.addClass("no-full"),
				a.hasClass("navbar-mobile") &&
				...
				a.hasClass("no-background") &&
					n(window).on("scroll", function () {
						var a = n(window).scrollTop();
						a > 34
							? n(".navbar-fixed").removeClass("no-background")
							: n(".navbar-fixed").addClass("no-background");
					}),
				a.hasClass("navbar-transparent") &&
					n(window).on("scroll", function () {
						var a = n(window).scrollTop();
						a > 34
							? n(".navbar-fixed").removeClass("navbar-transparent")
							: n(".navbar-fixed").addClass("navbar-transparent");
					}),
				...
				n("nav.navbar.bootsnav .attr-nav").each(function () {
					n("li.side-menu > a", this).on("click", function (a) {
						a.preventDefault(),
							n("nav.navbar.bootsnav > .side").toggleClass("on"),
							n("body").toggleClass("on-side");
					});
				}),
				n(".side .close-side").on("click", function (a) {
					a.preventDefault(),
						n("nav.navbar.bootsnav > .side").removeClass("on"),
						n("body").removeClass("on-side");
				});
		},
		hoverDropdown: function () {
			...
			if (991 > o) {
				n(".scroller").css("height", "auto"),
					n("nav.navbar.bootsnav ul.nav").find("li.dropdown").off("mouseenter"),
					n("nav.navbar.bootsnav ul.nav").find("li.dropdown").off("mouseleave"),
					n("nav.navbar.bootsnav ul.nav").find(".title").off("mouseenter"),
					n("nav.navbar.bootsnav ul.nav").off("mouseleave"),
					n(".navbar-collapse").removeClass("animated"),
					n("nav.navbar.bootsnav ul.nav").each(function () {
						n(".dropdown-menu", this).addClass("animated"),
							n(".dropdown-menu", this).removeClass(t),
							n("a.dropdown-toggle", this).off("click"),
							n("a.dropdown-toggle", this).on("click", function (a) {
								return (
									a.stopPropagation(),
									n(this)
										.closest("li.dropdown")
										...
										.fadeToggle()
										.toggleClass(e),
									n(this).closest("li.dropdown").first().toggleClass("on"),
									!1
								);
							}),
							n("li.dropdown", this).each(function () {
								return (
									...
									n(this).on("hidden.bs.dropdown", function () {
										n(this).find(".dropdown-menu").stop().fadeOut();
									}),
									!1
								);
							...
							n(".megamenu-fw", this).each(function () {
								n(".col-menu", this).each(function () {
									n(".content", this).addClass("animated"),
										n(".content", this).stop().fadeOut(),
										n(".title", this).off("click"),
										n(".title", this).on("click", function () {
											return (
												n(this)
													.closest(".col-menu")
													.find(".content")
													...
													.fadeToggle()
													.addClass(e),
												n(this).closest(".col-menu").toggleClass("on"),
												!1
											);
										}),
				...
				var i = function () {
					n("li.dropdown", this).removeClass("on"),
						n(".dropdown-menu", this).stop().fadeOut(),
						n(".dropdown-menu", this).removeClass(e),
						n(".col-menu", this).removeClass("on"),
						n(".col-menu .content", this).stop().fadeOut(),
						n(".col-menu .content", this).removeClass(e);
				};
				n("nav.navbar.bootsnav").on("mouseleave", function () {
					i();
				}),
					n("nav.navbar.bootsnav .attr-nav").each(function () {
						n(".dropdown-menu", this).removeClass("animated"),
							n("li.dropdown", this).off("mouseenter"),
							n("li.dropdown", this).off("mouseleave"),
							n("a.dropdown-toggle", this).off("click"),
							n("a.dropdown-toggle", this).on("click", function (a) {
								a.stopPropagation(),
									n(this)
									...
									n(".navbar-toggle").each(function () {
										n(".tr-icon", this).removeClass("ion-android-close"),
											n(".tr-icon", this).addClass("ion-android-menu"),
											n(".navbar-collapse").removeClass("in"),
											n(".navbar-collapse").removeClass("on");
									});
							}),
					...
					n(".navbar-toggle").each(function () {
						n(this).off("click"),
							n(this).on("click", function () {
								n(".tr-icon", this).toggleClass("ion-android-menu"),
									n(".tr-icon", this).toggleClass("ion-android-close"),
									i();
							});
					});
			} else
				o > 991 &&
					(n(".scroller").css("height", s + "px"),
					a.hasClass("navbar-sidebar")
						? n("nav.navbar.bootsnav ul.nav").each(function () {
								n("a.dropdown-toggle", this).off("click"),
									n("a.dropdown-toggle", this).on("click", function (n) {
										n.stopPropagation();
									}),
									n(".dropdown-menu", this).addClass("animated"),
									n("li.dropdown", this).on("mouseenter", function () {
										return (
											n(".dropdown-menu", this).eq(0).removeClass(t),
											n(".dropdown-menu", this)
												.eq(0)
												.stop()
												.fadeIn()
												.addClass(e),
									...
									n(".col-menu").each(function () {
										n(".content", this).addClass("animated"),
											n(".title", this).on("mouseenter", function () {
												return (
													n(this)
														.closest(".col-menu")
														.find(".content")
														...
														.fadeIn()
														.addClass(e),
													n(this).closest(".col-menu").addClass("on"),
													!1
												);
											});
									}),
									n(this).on("mouseleave", function () {
										return (
											n(".dropdown-menu", this).stop().removeClass(e),
											n(".dropdown-menu", this).stop().addClass(t).fadeOut(),
											n(".col-menu", this)
												.find(".content")
												.stop()
												.fadeOut()
						...
						: n("nav.navbar.bootsnav ul.nav").each(function () {
								n("a.dropdown-toggle", this).off("click"),
									...
									n(".megamenu-fw", this).each(function () {
										n(".title", this).off("click"),
											n("a.dropdown-toggle", this).off("click"),
											n(".content").removeClass("animated");
									}),
									n(".dropdown-menu", this).addClass("animated"),
									n("li.dropdown", this).on("mouseenter", function () {
										return (
									...
									n("li.dropdown", this).on("mouseleave", function () {
										n(".dropdown-menu", this).eq(0).removeClass(e),
											n(".dropdown-menu", this)
												.eq(0)
												.stop()
												.fadeOut()
												.addClass(t),
											n(this).removeClass("on");
									}),
									n(this).on("mouseleave", function () {
										return (
											n(".dropdown-menu", this).removeClass(e),
					...
					n("nav.navbar.bootsnav .attr-nav").each(function () {
						n("a.dropdown-toggle", this).off("click"),
							...
							n("li.dropdown", this).on("mouseenter", function () {
								return (
									n(".dropdown-menu", this).eq(0).removeClass(t),
									n(".dropdown-menu", this).eq(0).stop().fadeIn().addClass(e),
									n(this).addClass("on"),
									!1
								);
							}),
							n("li.dropdown", this).on("mouseleave", function () {
								n(".dropdown-menu", this).eq(0).removeClass(e),
									n(".dropdown-menu", this).eq(0).stop().fadeOut().addClass(t),
									n(this).removeClass("on");
							}),
							n(this).on("mouseleave", function () {
								return (
			...
			if (a.hasClass("navbar-full")) {
				var l = n(window).height(),
					d = n(window).width();
				n(".nav-full").css("height", l + "px"),
					n(".wrap-full-menu").css("height", l + "px"),
					n(".wrap-full-menu").css("width", d + "px"),
					n(".navbar-collapse").addClass("animated"),
					n(".navbar-toggle").each(function () {
						var a = n(this).data("target");
						n(this).off("click"),
							n(this).on("click", function (o) {
								return (
									o.preventDefault(),
									n(a).removeClass(t),
									n(a).addClass("in"),
			...
			if (a.length) {
				o.scrollspy({ target: ".navbar", offset: e }),
					n(".scroll").on("click", function (a) {
						...
						n("html, body").stop().animate({ scrollTop: r }, d);
					});
				var t = function () {
		...
		n(window).on("resize", function () {
			a.hoverDropdown(),
				...
				n(".navbar-toggle").each(function () {
					n(".tr-icon", this).removeClass("ion-android-close"),
						n(".tr-icon", this).addClass("ion-android-menu"),
						n(this).removeClass("fixed");
				}),
				n(".navbar-collapse").removeClass("in"),
				n(".navbar-collapse").removeClass("on"),
				n(".navbar-collapse").removeClass("bounceIn");
		});
})(jQuery);
...
!(function (a, b, c, d) {
				...
				fn: function () {
					...
					b.triggerEvent("beforeResizeGrid"),
						...
						b.width !== a &&
							...
							"slider" === b.options.layoutMode && b.updateSlider(),
				...
				f !== c.height &&
					...
					c.height !== d &&
						(e.Private.modernBrowser
							...
							: c.$obj.trigger("pluginResize.cbp")),
					(c.height = f),
					c.triggerEvent("resizeMainContainer"));
		},
			...
			d.wrapInner(b, "cbp-item-wrapper"),
				...
				d.loadImages(b, function () {
					d.$obj.addClass("cbp-addItems"),
						...
						"slider" === d.options.layoutMode && d.updateSlider(),
		...
		(b.prototype.registerFilter = function () {
			...
			(b.prototype.filtersCallback = function (b, c) {
				a.isEmptyObject(b) ||
					...
					b.headerText ? (b.headerText = "") : b.header.text(c.text())),
					c
				...
				init: function (b, d) {
					...
					if (
						...
						return (
							...
							void f.cubeportfolio.registerEvent("resizeGrid", function () {
								f.isOpen && f.close();
							})
						);
					if (
	...
	(function (a) {
		...
		(b.prototype.filterLayout = function () {
			...
			d.$obj.addClass("cbp-animation-" + d.options.animationType),
				d.blocksOn2On.addClass("cbp-item-on2on").each(function (b, d) {
					var e = a(d).data("cbp");
					d.style[c.Private.transform] =
						"translate3d(" +
						(e.leftNew - e.left) +
				...
				d.blocksOn2Off.addClass("cbp-item-on2off"),
				(d.blocksOff2On = d.blocksOn
					.filter(".cbp-item-off")
				...
				d.blocksOn2Off.length
					? d.blocksOn2Off
							.last()
							.data("cbp")
							.wrapper.one(c.Private.animationend, b)
					: d.blocksOff2On.length
					? d.blocksOff2On
							.last()
							.data("cbp")
							.wrapper.one(c.Private.animationend, b)
					: b(),
				d.resizeMainContainer();
		}),
			(b.prototype.destroy = function () {
				var a = this.parent;
	...
	(function (a) {
		...
		(b.prototype.filterLayout = function () {
			...
			var d = this,
				e = d.$ul.clone(!0, !0);
			e[0].setAttribute("class", "cbp-wrapper-helper"),
				d.wrapper[0].insertBefore(e[0], d.$ul[0]);
			var f = e.find(".cbp-item").not(".cbp-item-off");
			d.sortBlocks(f, "top"),
				f.children(".cbp-item-wrapper").each(function (a, b) {
					b.style[c.Private.animationDelay] = 50 * a + "ms";
				}),
				requestAnimationFrame(function () {
					d.$obj.addClass("cbp-animation-" + d.options.animationType),
						d.blocksOff.addClass("cbp-item-off"),
						d.blocksOn.removeClass("cbp-item-off").each(function (b, d) {
							var e = a(d).data("cbp");
							(e.left = e.leftNew),
								(e.top = e.topNew),
								(d.style.left = e.left + "px"),
				...
				b.registerEvent(
					...
					function () {
						b.blocksOn.each(function (a, d) {
							...
							b.blocksOn.last().one(c.Private.animationend, function () {
		...
		function b(b) {
			...
			b.pushQueue("delayFrame", d),
				b.registerEvent(
					"initEndWrite",
					function () {
						(b.obj.style[c.Private.animationDuration] =
							b.options.displayTypeSpeed + "ms"),
							b.$obj.addClass("cbp-displayType-fadeInToTop"),
							b.$obj.one(c.Private.animationend, function () {
			...
			b.pushQueue("delayFrame", d),
				b.registerEvent(
					...
					function () {
						(b.obj.style[c.Private.animationDuration] =
							b.options.displayTypeSpeed + "ms"),
							b.$obj.addClass("cbp-displayType-lazyLoading"),
							b.$obj.one(c.Private.animationend, function () {
								b.$obj.removeClass("cbp-displayType-lazyLoading"),
									(b.obj.style[c.Private.animationDuration] = ""),
									d.resolve();
							});
					},
			...
			sliderMarkup: function () {
				...
				(b.sliderStopEvents = !1),
					...
					b.options.auto &&
						...
						b.startSliderAuto()),
					b.options.drag && e.Private.modernBrowser && b.dragSlider();
			},
