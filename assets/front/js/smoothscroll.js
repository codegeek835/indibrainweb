...
(function () {
  ...
  function init() {
     ...
     */
      ...
      fullPageElem.style.cssText =
        'position:absolute; z-index:-10000; ' + 'top:0; left:0; right:0; height:' + root.scrollHeight + 'px';
  ...
  function keydown(event) {
    ...
    if (
      (isNodeName(target, 'button') || (isNodeName(target, 'input') && buttonTypes.test(target.type))) &&
