...
jQuery(function ($) {
	...
	jQuery(document).ready(function ($) {
		...
		$(window).on("scroll", function () {
			...
			var el = document.querySelector("#topNavStatic");
			if (
				scrollTop >=
				...
				$(".top_search_fixed").show();
			} else {
				$(".top_search_fixed").hide();
			}
		});
				...
				.revolution({
					...
					navigation: {
						...
						tabs: {
							...
							wrapper_opacity: "0",
							tmp:
								'<div class="tp-tab-wrapper"><div class="tp-tab-number">{{param1}}</div><div class="tp-tab-divider"></div><div class="tp-tab-title-mask"><div class="tp-tab-title">{{title}}</div></div></div>',
							visibleAmount: 5,
							hide_onmobile: true,
							hide_under: 800,
							hide_onleave: false,
