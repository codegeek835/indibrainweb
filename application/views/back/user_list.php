            ...
            <div class="col-lg-12">
               ...
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="dataTables_info">User Tables</div>
                        </div>
                        <div class="col-sm-6">
                              ...
                              <tr class="gradeC">
                                ...
                                <td>
                                    ...
                                    <?php if($user->user_status=='1'){?>
                                        <a class="btn btn-primary btn-xs" href="<?php  echo base_url();?>user-status/<?php echo $user->user_id;?>" title="Click to Deactive">Active</a>
                                    <?php }else{?>
                                    <a class="btn btn-danger btn-xs" href="<?php  echo base_url();?>user-status/<?php echo $user->user_id;?>" title="Click to Active">DeActive</a>
                                    <?php }?>
                                </td>
                                 <td>
                                    ...
                                    <a class="btn btn-danger" href="<?php  echo base_url();?>delete-user/<?php echo $user->user_id;?>">Delete</a>
                                 </td>
                              </tr>
                              <?php }} ?>
                           </tbody>
               ...
               <div class="modal fade" id="userModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                     <div class="modal-content">
                        ...
                        <?php echo form_open_multipart('save-user','');?>
                        <div class="modal-body">
                           <div class="container-fluid">
                              <div class="row">
                                 <div class="col-lg-6">
               ...
               <!--End Advanced Tables -->
               <script>
                  function edituserModal(user_id,username,user_email,user_phone,user_password,address,country,state,city,pincode,image)
                  {
                     ...
                     if(image){
                        ...
                        var url = "<?php echo base_url('assets/front/profile/');?>"+image;
