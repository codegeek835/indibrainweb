      ...
      <div class="row">
         <div class="col-md-8 col-sm-12 centerize-col m-t-110">
            <div class="text-center white-color">
               <h1 class="font-400 play-font font-italic font-style">Order Details</h1>
            </div>
         </div>
      </div>
   </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          <h4><b>Name:</b> <?php echo $ship_info->username?></h4>
                          <h4><b>Email:</b> <?php echo $ship_info->user_email?></h4>
                          <h4><b>Mobie:</b> <?php echo $ship_info->user_phone?></h4>
                          <h4><b>Address:</b> <?php echo $ship_info->address?></h4>
                          <h4><b>City:</b> <?php echo $ship_info->city?></h4>
                          <h4><b>Country:</b> <?php echo $ship_info->country?></h4>
                          <h4><b>Zip:</b> <?php echo $ship_info->pincode?></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
