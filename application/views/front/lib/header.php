...
<head>
    ...
    <style>
        ...
        .topsearch a, .topsearch input[type=text], .topsearch .search-container button {
        float: none;
        display: block;
        text-align: left;
        width: 100%;
                  ...
                  <div class="logo">
                    ...
                    <div id="top_search" class="fix_s topsearch">       
                        ...
                        <form  method="GET" action="<?php echo base_url('category/photos');?>">
                            <input type="text" placeholder="Search free photos and more" name="s" value="<?php if(isset($_GET['s'])){echo $_GET['s'];}?>" required>
