...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/front/css/signup.css')?>" />
    ...
    <script type="text/javascript">
      function submitFormTop() {
        ...
        document.getElementById('submitFormTop').action = 'category/' + selected;
      }
    </script>
  </head>
  <body>
      ...
      <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full brand-center bg-w">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <div class="logo">
              <a href="<?php echo base_url('/')?>" class="logoLink">
                <img class="logo logo-display" src="<?php echo base_url()?>assets/front/images/logo.png" alt="" />
                <img class="logo logo-scrolled" src="<?php echo base_url()?>assets/front/images/logo.png" alt="" />
              </a>
            </div>
            <!-- -->
            <div class="slider-text top_search_fixed">
              <div class="col-md-9 col-sm-12 centerize-col">
                <div class="text-center white-color">
                  <div id="top_search_fixed" class="topnav fix_s topsearch">
                    <div class="search-container">
                      <form id="submitFormTop" method="GET" onsubmit="submitFormTop()">
                        ...
                        <button type="submit" onclick="submitFormTop()">Search</button>
                      </form>
                    </div>
                  </div>
                </div>
          ...
          <div class="collapse navbar-collapse bg-w" id="navbar-menu">
            <ul class="nav navbar-nav navbar-center">
              ...
              <li class="dropdown">
                <a href="#" class="" data-toggle="dropdown" style="font-size: 14px"
                  ><i class="fa fa-user-circle-o dis-block"></i
                  ><?php echo substr($this->session->userdata('user_name'), 0,8)?><b class="caret"></b
                ></a>
                <ul class="dropdown-menu drop">
                  <li>
                    <a href="<?php echo base_url('my-account/').getEncrypt($this->session->userdata('user_id'))?>"
                      ><i class="fa fa-user-circle-o dis-block"></i> My Account</a
                    >
                  </li>
                  <li class="divider"></li>
                  <li>
                    <a href="<?php echo base_url('my-wishlist/').getEncrypt($this->session->userdata('user_id'))?>"
                      ><i class="fa fa-user-circle-o dis-block"></i> My wishlist</a
                    >
                  </li>
                  <li class="divider"></li>
                  <li>
                    <a href="<?php echo base_url('logout')?>"><i class="fa fa-sign-out dis-block"></i> Logout</a>
                  </li>
                </ul>
              </li>
              <?php }else{ ?>
          ...
          <div style="right: 4px" class="attr-nav hidden-xs sm-display-none cart-icon">
            <ul>
              <li class="search1">
                <a href="<?php echo base_url('cart')?>" id="search-button" class="head-slid">Cart</a>
              </li>
              <?php if($this->session->userdata('user_id')){?>
