   ...
   <div>
      <div class="row">
         <div class="col-md-12 text-center">
            <div>
               <marquee onMouseOver="this.stop()" onMouseOut="this.start()"><a href="#">
                     <h3 class="white-color">Latest Offer Should be runing here e.g. "Get 50% off on Prime Section Use code - INTR050"</h3>
                  </a></marquee>
      ...
      <div class="row">
         <div class="col-md-3">
            <a href="<?php echo base_url('vertical/photos'); ?>">
               <div class="box portfolio-item">
                  ...
                  <img class="h-w1" src="<?php if (getVerticalImage('photos')) {
                                             echo base_url('uploads/') . getVerticalImage('photos');
                                          } else { ?>https://free-images.com/lg/346c/old_in_new_orleans.jpg<?php } ?>" alt="">
                  <div class="box-text">
                     <h4>Photos</h4>
                  </div>
               </div>
         ...
         <div class="col-md-3">
            <a href="<?php echo base_url('vertical/vector'); ?>">
               <div class="box portfolio-item">
                  <img class="h-w1" src="<?php if (getVerticalImage('vector')) {
                                             echo base_url('uploads/') . getVerticalImage('vector');
                                          } else {
                                             echo "https://free-images.com/lg/5c2f/flower_vector_background_brochure.jpg";
                                          } ?>" alt="">
                  <div class="box-text">
                     <h4>Vectors</h4>
                  </div>
         ...
         <div class="col-md-3">
            <a href="<?php echo base_url('vertical/arts'); ?>">
               <div class="box portfolio-item">
                  ...
                  <img class="h-w1" src="<?php if (getVerticalImage('arts')) {
                                             echo base_url('uploads/') . getVerticalImage('arts');
                                          } else {
                                             echo "https://pngimg.com/uploads/house/house_PNG50.png";
                                          } ?>" alt="">
                  <div class="box-text">
                     <h4>Arts</h4>
                  </div>
         ...
         <div class="col-md-3">
            <a href="<?php echo base_url('vertical/prints'); ?>">
               <div class="box portfolio-item">
                  ...
                  <img class="h-w1" src="<?php if (getVerticalImage('prints')) {
                                             echo base_url('uploads/') . getVerticalImage('prints');
                                          } else {
                                             echo "https://free-images.com/lg/e1b0/calidris_alba_bird_nature.jpg";
                                          } ?>" alt="">
                  <div class="box-text">
                     <h4>Prints</h4>
                  </div>
