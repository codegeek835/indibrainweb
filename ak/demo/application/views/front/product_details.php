            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
              <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img" src='<?php echo base_url().$product_info->pro_image?>' data-zoom-image="<?php echo base_url().$product_info->pro_image?>" alt="product_img1" />
                    ...
                    <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                        <div class="item">
                            <a href="#" class="product_gallery_item active" data-image="<?php echo base_url().$product_info->pro_image?>" data-zoom-image="<?php echo base_url().$product_info->pro_image?>">
                                <img src="<?php echo base_url().$product_info->pro_image?>" alt="product_small_img1" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#" class="product_gallery_item active" data-image="<?php echo base_url()?>assets/images/similar1.jpg" data-zoom-image="<?php echo base_url()?>assets/images/similar1.jpg">
                                <img src="<?php echo base_url()?>assets/images/similar1.jpg" alt="product_small_img1" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#" class="product_gallery_item active" data-image="<?php echo base_url()?>assets/images/similar2.jpg" data-zoom-image="<?php echo base_url()?>assets/images/similar2.jpg">
                                <img src="<?php echo base_url()?>assets/images/similar2.jpg" alt="product_small_img1" />
                            </a>
                        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="pr_detail">
                    <div class="product_description">
                        <h4 class="product_title"><?php echo $product_info->pro_title;?></h4>
                        <div class="product_price">
                            <span class="price">$<?php echo number_format($product_info->pro_price,2);?></span>
                        </div>
                        ...
                        <div class="pr_switch_wrap">
                            <span class="switch_lable"><b>Availability :</b></span>
                    ...
                    <ul class="product-meta">
                        ...
                        <li>Brand: <?php echo $product_info->brand_name?> </li>
                    </ul>
